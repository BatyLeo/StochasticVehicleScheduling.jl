...
seed = 0 # seed to generate datasets
...
dataset_25 = generate_dataset(
    b, 150; algorithm=compact_mip, model_builder, silent=false, seed
);
dataset_50 = generate_dataset(b_50, 150; algorithm=local_search, num_iterations, seed);
dataset_100 = generate_dataset(b_100, 150; algorithm=local_search, num_iterations, seed);

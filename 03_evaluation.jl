...
opt_test = mean([evaluate_solution(i.y_true, i.instance) for i in test_set_25]) # 20731.859918365783
...
greedy_test = mean([evaluate_solution(deterministic_mip(i.instance; model_builder=grb_model), i.instance) for i in test_set_25]) # 23201.427197243487
...
SL_test = mean([evaluate_solution(maximizer(supervised_model(i.x); instance=i.instance), i.instance) for i in test_set_25]) # 21078.99508454414
...
RM_test = mean([evaluate_solution(maximizer(experience_model(i.x); instance=i.instance), i.instance) for i in test_set_25]) # 20942.81209049026
SL_final_train_rew = [evaluate_solution(maximizer(supervised_model(i.x); instance=i.instance), i.instance) for i in train_set_25]
SL_final_test_rew = [evaluate_solution(maximizer(supervised_model(i.x); instance=i.instance), i.instance) for i in test_set_25]
...
opt_final_test_rew = [evaluate_solution(i.y_true, i.instance) for i in test_set_25]
...
greedy_final_test_rew = [evaluate_solution(deterministic_mip(i.instance; model_builder=grb_model), i.instance) for i in test_set_25]
...
################
supervised_model = JLD2.load("logs/svsp_sl_best_model.jld2")["model"]
PPO_model = JLD2.load("logs/svsp_ppo_best_model.jld2")["model"]
IL_model = JLD2.load("logs/svsp_il_best_model.jld2")["model"]

mean([evaluate_solution(i.y_true, i.instance) for i in train_set_25])
mean([evaluate_solution(deterministic_mip(i.instance; model_builder=grb_model), i.instance) for i in train_set_25])
mean([evaluate_solution(maximizer(supervised_model(i.x); instance=i.instance), i.instance) for i in train_set_25])
mean([evaluate_solution(maximizer(PPO_model(i.x); instance=i.instance), i.instance) for i in train_set_25])
mean([evaluate_solution(maximizer(IL_model(i.x); instance=i.instance), i.instance) for i in train_set_25])

mean([evaluate_solution(i.y_true, i.instance) for i in test_set_50])
mean([evaluate_solution(deterministic_mip(i.instance; model_builder=grb_model), i.instance) for i in train_set_50])
mean([evaluate_solution(maximizer(supervised_model(i.x); instance=i.instance), i.instance) for i in train_set_50])
mean([evaluate_solution(maximizer(PPO_model(i.x); instance=i.instance), i.instance) for i in train_set_50])
mean([evaluate_solution(maximizer(IL_model(i.x); instance=i.instance), i.instance) for i in train_set_50])

mean([evaluate_solution(i.y_true, i.instance) for i in test_set_100])
mean([evaluate_solution(deterministic_mip(i.instance; model_builder=grb_model), i.instance) for i in train_set_100])
mean([evaluate_solution(maximizer(supervised_model(i.x); instance=i.instance), i.instance) for i in train_set_100])
mean([evaluate_solution(maximizer(PPO_model(i.x); instance=i.instance), i.instance) for i in train_set_100])
mean([evaluate_solution(maximizer(IL_model(i.x); instance=i.instance), i.instance) for i in train_set_100])
...
function create_mini_instance(delay::Float64)
    ...
    city_center = VSP.Point(25.0, 25.0)
    tasks = VSP.Task[]
    ...
    p1 = VSP.Point(25.0, 30.0)
    push!(
        tasks,
        VSP.Task(
            VSP.depot_start, p1, p1, 60, 120, VSP.ZERO_UNIFORM, [60.0], [120.0 + delay]
        ),
    )

    p2 = VSP.Point(25.0, 35.0)
    push!(
        tasks,
        VSP.Task(VSP.depot_start, p2, p2, 130, 140, VSP.ZERO_UNIFORM, [125.0], [140.0]),
    )
